...
class TestRunner:
    ...
    def run_coverage(self, html: bool = True) -> int:
        ...
        cmd = [sys.executable, "-m", "pytest", "--cov=services", "--cov-report=term-missing"]
    ...
    def run_linting(self) -> int:
        ...
        black_result = self.run_command([sys.executable, "-m", "black", "--check", "--diff", "services", "tests"])
        
        # Flake8 linting
        print("📋 Running flake8 linting...")
        flake8_result = self.run_command([sys.executable, "-m", "flake8", "services", "tests"])
