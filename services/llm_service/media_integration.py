    ...
    def analyze_media(self, media_id: str, analysis_type: str = "full") -> Dict:
        ...
        try:
            ...
            media_response = requests.get(
                f"{self.media_service_url}/media/{media_id}"
            )
            ...
            analysis_response = requests.post(
                f"{self.media_service_url}/analyze",
    ...
    def generate_media_description(self, media_id: str, style: str = "neutral") -> str:
        ...
        try:
            ...
            description_response = requests.post(
                f"{self.media_service_url}/describe",
                json=description_request
            )
            
            if description_response.status_code != 200:
                logger.error(f"Fehler bei der Beschreibungsgenerierung: {description_response.text}")
                return None
    ...
    def search_similar_media(self, media_id: str, limit: int = 5) -> List[Dict]:
        ...
        try:
            ...
            search_response = requests.post(
                f"{self.media_service_url}/search-similar",
                json=search_request
            )
