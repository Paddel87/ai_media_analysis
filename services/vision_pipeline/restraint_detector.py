    ...
    def _analyze_frame_internal(self, frame: np.ndarray) -> Dict[str, Any]:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                logger.log_error("Fehler bei der Restraint-Analyse", extra={
        ...
        try:
            ...
            for result in results:
                if "restraint_data" in result and "results" in result["restraint_data"]:
                    filtered_data = [
                        item for item in result["restraint_data"]["results"]
            ...
            logger.log_info("Restraint-Ergebnisse gefiltert", extra={
