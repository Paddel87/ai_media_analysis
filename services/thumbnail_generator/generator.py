...
class ThumbnailGenerator:
    ...
    def generate_thumbnails(self, video_path: str, output_dir: str, num_thumbnails: int = 4) -> List[str]:
        """
        ...
        try:
            ...
            intervals = [duration * (i + 1) / (num_thumbnails + 1) for i in range(num_thumbnails)]
...
def process_video(video_path: str, job_id: str):
    ...
    try:
        ...
        logger.info(f"Vorschaubilder generiert für Job {job_id}: {len(thumbnail_paths)} Bilder")
        return thumbnail_paths
