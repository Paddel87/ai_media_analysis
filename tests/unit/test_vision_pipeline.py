...
class MockVisionPipeline:
    ...
    def process_image(self, image: np.ndarray) -> Dict[str, Any]:
        ...
        results = {
            ...
            "objects": [{"class": "person", "confidence": 0.8, "bbox": [50, 50, 200, 300]}]
        }
        return results
...
class TestVisionPipeline:
    ...
    def test_image_validation_invalid_shape(self, mock_config):
        ...
        pipeline = MockVisionPipeline(mock_config)
        invalid_image = np.random.randint(0, 255, (224, 224), dtype=np.uint8)  # 2D statt 3D
    ...
    def test_image_validation_invalid_channels(self, mock_config):
        ...
        pipeline = MockVisionPipeline(mock_config)
        invalid_image = np.random.randint(0, 255, (224, 224, 4), dtype=np.uint8)  # 4 Kanäle statt 3
...
class TestNSFWDetection:
    ...
    def setup_method(self):
        ...
        self.nsfw_detector.predict.return_value = {
            "safe": 0.9,
            "unsafe": 0.1
        }
        ...
        self.face_detector.detect_faces.return_value = [
            {
                "bbox": [100, 100, 50, 60],
                "confidence": 0.95,
                "landmarks": [[110, 115], [140, 115], [125, 130], [120, 145], [130, 145]]
            }
        ]
